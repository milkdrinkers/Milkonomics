...
public final class FileUtils {
    ...
    public static void extractResource(
        ...
        try (
            InputStream stream = MilkonomicsPlugin.getInstance().getResource(resourcePath.toString().replace('\\', '/'))
        ) {
            if (stream == null)
    ...
    public static Set<String> resourceListFiles(
        ...
        final URL url = MilkonomicsPlugin.getInstance().getClass().getResource("");
