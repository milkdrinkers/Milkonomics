...
public class BStatsHook extends AbstractHook {
    private final static int BSTATS_ID = 29996; // Signup to BStats and register your new plugin here: https://bstats.org/getting-started, replace the id with you new one!
