package io.github.milkdrinkers.milkonomics.database.config;
...
public class DatabaseConfig {
     ...
     */
    public static DatabaseConfig fromConfig(io.github.milkdrinkers.milkonomics.config.DatabaseConfig cfg, Path databasePath) {
        return builder()
